 ...
 * For practical applications, replace the sample text with real world values.
 * For example: 
 *  $host can be a hostname 'my_host' or IP address '127.0.0.1'
 *    For remote connections you need to add a port number such as 3306.
...
/**
*  Make sure the connection succeeded. If the connection failed, display an error message.
*/
...
* 
* For this example we are leaving the connection open to perform some operations.
*/
